...
import com.restfull.enums.Race;
...
public class JacksonConfig {
    ...
    public SimpleModule raceModuleMapper() {
        ...
        dateModule.addSerializer(Race.class, new RaceCerialize());
        dateModule.addDeserializer(Race.class, new RaceDescerialize());
        return dateModule;
    }
    ...
    class RaceDescerialize extends StdDeserializer<Race> {
        public RaceDescerialize() {
            super(Race.class);
        }
